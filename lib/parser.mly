...
stmt:
  ...
  | dtype ID LSQUARE RSQUARE ASSIGN LSQUARE expr_list RSQUARE EOL                    { Assign ($1, $2, ArrayLit $7) }
  | ID LSQUARE RSQUARE ASSIGN LSQUARE expr_list RSQUARE EOL                          { InferAssign ($1, ArrayLit $6) }
